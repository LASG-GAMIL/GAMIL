...
! For the Observation decomposition
      ...
      REAL, ALLOCATABLE :: Rglobal(:), Rtmp(:), RlocalA(:), RlocalB(:)
      REAL, ALLOCATABLE :: R2dlocalA(:), R2dlocalB(:)
      REAL, ALLOCATABLE :: R2dGlobal(:), R2dtmp(:)
!
! 3D Arrays are smashed down to 1D
!
      REAL, ALLOCATABLE :: R3dlocalA(:), R3dlocalB(:)
      REAL, ALLOCATABLE :: R3dGlobal(:), R3dTmp(:)
