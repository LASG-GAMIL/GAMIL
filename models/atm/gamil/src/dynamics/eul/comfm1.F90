module comfm1
    ...
    real(r8), allocatable :: CX (:,:,:)
    real(r8), allocatable :: CY (:,:,:)
...
contains
    ...
    subroutine initialize_comfm1
        ...
        allocate (CX  (beglonex:endlonex, beglatexdyn:endlatexdyn, plev))
        allocate (CY  (beglonex:endlonex, beglatexdyn:endlatexdyn, plev))
        ...
        call register_comm_array(beglonex,endlonex,beglatexdyn,endlatexdyn,1,plev,1,1,CX(:,beglatexdyn,1))
        call register_comm_array(beglonex,endlonex,beglatexdyn,endlatexdyn,1,plev,1,1,CY(:,beglatexdyn,1))
