!===============================================================================
! CVS $Id: shr_const_mod.F90,v 1.2.18.2 2002/06/21 05:43:52 erik Exp $
! CVS $Source: /fs/cgd/csm/models/CVS.REPOS/shared/csm_share/shr_const_mod.F90,v $
...
!         WARNING:  the constant SHR_CONST_ICE_REF_SAL must be
!         set to zero (0.0_SHR_KIND_R8) because of internal
!         assumptions used in the CCSM2.0 sea-ice model (csim4.0).
!         Unexpected and incorrect results will occur if
!         SHR_CONST_ICE_REF_SAL is modified by the user.

   real(SHR_KIND_R8),parameter :: SHR_CONST_OCN_REF_SAL = 34.7_SHR_KIND_R8    ! ocn ref salinity (psu)
   real(SHR_KIND_R8),parameter :: SHR_CONST_ICE_REF_SAL =  0.0_SHR_KIND_R8    ! ice ref salinity (psu)
