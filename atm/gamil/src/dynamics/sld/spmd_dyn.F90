...
!-----------------------------------------------------------------------
     ...
     integer length,i
!
! realloc4 max: 12 2 plev*numm*numlats (e.g. grt1)
!               2  2     *numm*numlats (grlps1, grlps2)
!               2             *numlats (begirow, endirow)
!
     maxcount(1) = maxlats*(2*maxm*(plev*12 + 2) + 2)

!
! realloc6 max: 4 plev*(nlen*numm)  (e.g. vz)
!               1     *(nlen*numm)  (alps)
!               2                   (length, mstrt)
!
     length = 0
