!===============================================================================
! CVS $Id: shr_msg_mod.F90,v 1.8.18.1 2002/06/21 05:43:53 erik Exp $
! CVS $Source: /fs/cgd/csm/models/CVS.REPOS/shared/csm_share/shr_msg_mod.F90,v $
...
!
   public shr_msg_stdio,  shr_msg_chdir,  shr_msg_dirio, &
          shr_msg_init,   shr_msg_groups, shr_msg_errstr, shr_msg_finalize, &
          shr_msg_send_i, shr_msg_send_r, shr_msg_send_c, &
          shr_msg_recv_i, shr_msg_recv_r, shr_msg_recv_c, &
          shr_msg_wait,   shr_msg_test
   !-----------------------------------------------------------------
...
!   where the desired cwd & files are specified by env variables.
   ...
   call shr_msg_chdir(model)
   call shr_msg_dirio(model)
...
!-------------------------------------------------------------------------------
   ...
   write(6,F00) 'chdir for model = ',model
...
!-------------------------------------------------------------------------------
! PURPOSE:
!   1) redirect stdin & stdout (units 5 & 6) to named files,
!   where the desired cwd & files are specified by env variables.
!
!   Normally this is done to work around limitations in the execution syntax of
!   common MPI implementations.  For example, SGI's mpirun syntax is not 
