!===============================================================================
! CVS: $Id: shr_orb_mod.F90,v 1.5.18.1 2001/12/18 19:40:06 eaton Exp $
! CVS: $Source: /fs/cgd/csm/models/CVS.REPOS/shared/csm_share/shr_orb_mod.F90,v $
...
!-------------------------------------------------------------------------------
   ...
   if ( log_print ) then
     ...
     write(6,F00) 'CVS revision: $Revision: 1.5.18.1 $'
     write(6,F00) 'CVS Tag     : $Name: cam2_0_1_brnchT_release3 $'
   end if
